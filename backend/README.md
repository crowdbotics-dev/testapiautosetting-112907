...
## Project Structure
    ...
    ├── testapiautosetting_112907  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_112907`
...
2. Clone this repo and `cd testapiautosetting_112907`
